...
SPACE_SHIP_WIDTH,SPACE_SHIP_HEIGHT=65,60
...
def bullet_handle(yellow_bullet,red_bullet,yellow,red):
...
def draw(red,yellow,red_bullet,yellow_bullet,red_health,yellow_health):
    # WIN.fill(WHITE)
    WIN.blit(SPACE,(0,0))
...
def main():
    ...
    while run:
        ...
        bullet_handle(yellow_bullet,red_bullet,yellow,red)
